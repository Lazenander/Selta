# Boundary candidate artifact resolver
...
presence artifacts by identity and adds only the open application-record
schema source. Paths are repository locations, not identity preimages.

## Root and specification artifacts

| Identity | Domain | Repository artifact |
|---|---|---|
| `sha256:5059697608b5bb6669cf93122a7c360ac18b68cc2e8612236e51a0634387b566` | `selta.evidence.environment/candidate-1` | [environment.json](environment.json) |
...
| `sha256:bc899c6733c11b1c452e811ef662cb7bc808e792c3c18af64fd4e6f763283ea0` | `selta.evidence.implementation/candidate-1` | [docs/19-presence-reference-profile.md as the specification oracle, not native code](../../../docs/19-presence-reference-profile.md) |

The evaluation-profile identity is embedded in the environment and has no
separate source artifact. No semantic specification or implementation is
introduced by this boundary profile.

## Schema-source artifacts

Every identity below uses `selta.evidence.schema-source/candidate-1` over
the canonical stable-Selta admitted `Node` projection.
...
| `sha256:0a823964c6368f09bce16c1d2400d4a86d25e0b005f7c5604a42e551dd168df4` | [non_empty.schema.json](../presence-candidate-1/builtin-config-schemas/non_empty.schema.json) and [unit.schema.json](../presence-candidate-1/schemas/unit.schema.json) |
...
| `sha256:d4bb1f321b19d352562cc09214630a35d7437a060ad97ea361b4cff967c65444` | [assumption-rule-input.schema.json](../presence-candidate-1/schemas/assumption-rule-input.schema.json) |
| `sha256:d85f64944d23b45d0178e7a9ebf79842974350bebafcb7bdd386f5bf5fb640c7` | [application-record.schema.json](schemas/application-record.schema.json) |
...
| `sha256:f31243a2ac7d389e726b0eaa97a7a376027bb0658ca7a408625e104d6cf73f8e` | [assumption-rule-parameters.schema.json](../presence-candidate-1/schemas/assumption-rule-parameters.schema.json) |
...
The presence unit and `non_empty` configuration schemas intentionally share
one identity because their admitted canonical projections are equal.
